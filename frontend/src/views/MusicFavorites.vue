<template>
  <div class="min-h-screen bg-gradient-to-br from-ocean-50 via-white to-sea-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2 text-center">🎵 今日音乐</h1>
      ...
      <div v-else class="flex justify-center">
        <div class="max-w-sm w-full card overflow-hidden">
...
const item = ref<Music | null>(null)
